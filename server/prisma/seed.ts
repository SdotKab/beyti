...
async function main() {
  ...
  const orderedFileNames = [
    ...
    "property.json", // Depends on location and user
    "document.json", // No dependencies
    "equitysnapshot.json", // Depends on property and tenant
    "inspection.json", // Depends on property and tenant
    "maintenance.json", // Depends on lease
    "mortgage.json", // Depends on property
  ];
